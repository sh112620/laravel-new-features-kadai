 ...
 <div class="row">
     ...
     <div class="col-9">
         ...
         <div>
             ...
             <?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('review', 'Review'));?>
         </div>         
                     ...
                     <div class="row">
                         <div class="col-12">
                             <p class="samuraimart-product-label mt-2">
                                 ...
                                 <span class="star-rating" data-rate="<?php echo e(round( $product->reviews->avg('score')*2 )/2, false); ?>"></span>
                                 <span class="review-score"><?php echo e($product->reviews->count(), false); ?></span><br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/kadai_003/laravel-samuraimart/resources/views/products/index.blade.php ENDPATH**/ ?>