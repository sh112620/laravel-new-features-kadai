                 ...
                 <div class="row">
                     <div class="col-12">
                         <p class="samuraimart-product-label mt-2">
                             ...
                             <span class="star-rating" data-rate="{{ round( $recommend_product->reviews->avg('score')*2 )/2 }}"></span>
                             <span class="review-score">{{ $recommend_product->reviews->count() }}</span><br>
                 ...
                 <div class="row">
                     <div class="col-12">
                         <p class="samuraimart-product-label mt-2">
                             ...
                             <span class="star-rating" data-rate="{{ round( $recently_product->reviews->avg('score')*2 )/2 }}"></span>
                             <span class="review-score">{{ $recently_product->reviews->count() }}</span><br>
