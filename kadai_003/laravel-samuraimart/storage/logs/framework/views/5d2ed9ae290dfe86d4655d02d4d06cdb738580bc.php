     ...
     <div class="row w-75">
         ...
         <div class="col">
             <div class="d-flex flex-column">
                 ...
                 <p>
                 <span class="star-rating" data-rate="<?php echo e(round( $product->reviews->avg('score')*2 )/2, false); ?>">
                 </span>
                 </p>
                 <p class="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel-samuraimart/resources/views/products/show.blade.php ENDPATH**/ ?>