                 ...
                 <div class="row">
                     <div class="col-12">
                         <p class="samuraimart-product-label mt-2">
                             ...
                             <span class="star-rating" data-rate="<?php echo e(round( $recommend_product->reviews->avg('score')*2 )/2, false); ?>"></span>
                             <span class="review-score"><?php echo e($recommend_product->reviews->count(), false); ?></span><br>
                 ...
                 <div class="row">
                     <div class="col-12">
                         <p class="samuraimart-product-label mt-2">
                             ...
                             <span class="star-rating" data-rate="<?php echo e(round( $recently_product->reviews->avg('score')*2 )/2, false); ?>"></span>
                             <span class="review-score"><?php echo e($recently_product->reviews->count(), false); ?></span><br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/kadai_003/laravel-samuraimart/resources/views/web/index.blade.php ENDPATH**/ ?>